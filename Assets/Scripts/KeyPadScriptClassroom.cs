...
public class KeyPadScriptClassroom : MonoBehaviour
{
    ...
    public GameObject closeButton;      // Refer�ncia ao bot�o de fechar
    public GameObject keyItem;          // Objeto chave que ser� revelado
    ...
    {
        if (codeOfKeypad.text == "52334") // Verifica se o c�digo est� correto
        {
    ...
    // Fechar o Keypad manualmente pelo bot�o
