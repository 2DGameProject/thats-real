...
{
    public static DicasManagerBoss Instance { get; private set; }  // Inst�ncia est�tica para Singleton
    ...
    void ExibirDica()
    {
        ...
        dicaTexto.text = "Dica gr�tis: Presta aten��o nas letras mai�sculas.\n\n" +
