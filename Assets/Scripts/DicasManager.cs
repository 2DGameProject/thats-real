...
{
    public static DicasManager Instance { get; private set; }  // Inst�ncia est�tica para Singleton
    ...
    void ExibirDica()
    {
        ...
        dicaTexto.text = "Dica gr�tis: Veja o que est� na mesa do Professor e o que est� escrito no quadro.\n\n" +
                         "Dica: As informa��es do quadro e a f�rmula podem ser �teis para abrir o arm�rio com senha.\n\n" +
    ...
    public void AtualizarDica()
    {
        dicaTexto.text = "Dica gr�tis: Veja o que est� na mesa do Professor e o que est� escrito no quadro.\n\n" +
                         "Dica: As informa��es do quadro e a f�rmula podem ser �teis para abrir o arm�rio com senha.\n\n" +
                         "Dica: Na mesa do professor ter� uma f�rmula que voc� usar� juntamente com a informa��o que est� no quadro, " +
                         "no quadro tem-se o layout da sala e cada coluna representa a posi��o no resultado aplicando a f�rmula e contando as carteiras de cada coluna no cadeado.";
