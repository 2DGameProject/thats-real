...
public class DicasManager : MonoBehaviour
{
    public static DicasManager Instance { get; private set; }  // Instância estática para Singleton
    ...
    void ExibirDica()
    {
        ...
        dicaTexto.text = "Dica grátis: Veja o que está na mesa do Professor e o que está escrito no quadro.\n\n" +
                         "Dica: As informações do quadro e a fórmula podem ser úteis para abrir o armário com senha.\n\n" +
    ...
    public void AtualizarDica()
    {
        dicaTexto.text = "Dica grátis: Veja o que está na mesa do Professor e o que está escrito no quadro.\n\n" +
                         "Dica: As informações do quadro e a fórmula podem ser úteis para abrir o armário com senha.\n\n" +
                         "Dica: Na mesa do professor terá uma fórmula que você usará juntamente com a informação que está no quadro, " +
                         "no quadro tem-se o layout da sala e cada coluna representa a posição no resultado aplicando a fórmula e contando as carteiras de cada coluna no cadeado.";
